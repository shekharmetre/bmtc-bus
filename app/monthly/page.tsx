...
const Monthly = () => {
    ...
    const [openImageReview, onOpenChange] = useState(false)
    ...
    return (
        ...
        <section className="relative bg-background overflow-hidden min-h-screen">
                ...
                <div className="shadow-sm shadow-black/20 m-2 bg-white  h-full rounded-md p-3">
                    <div className="flex gap-4 items-center">
                        ...
                        <div>
                            ...
                            <p className="mt-4">TPASS964211710</p>
                        </div>
                    </div>
                ...
                <div className="shadow-md m-1 mt-24 bg-white  h-full rounded-md p-3 pb-8">
                    ...
                    <div className="relative">
                        ...
                        {getValueFromArray(data, "image", "desc") ? (
                            <Image
                                onClick={() => setShowImage(true)} // u have to open model with that image
            ...
            <Dialog open={showImage} onOpenChange={() => setShowImage(false)}>
                ...
                >
                    {/* ❌ DialogClose default — removed */}
                    {/* ✅ Custom close button */}
                    <button
                        onClick={() => setShowImage(false)}
                        className="absolute top-4 right-4 text-white bg-black/40 p-1.5 rounded-full"
                    >
                        <svg
